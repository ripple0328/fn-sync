...
> The current version is `0.10.2`. Discovery, authorization, folder browsing,
...
- `fn-sync-0.10.2-1-any.pkg.tar.zst`: Arch/pacman system package.
- `fn-sync-omarchy-plugin-0.10.2.tar.gz`: self-contained Omarchy plugin.
- `fn-sync-omarchy-bundle-0.10.2.tar.gz`: portable bundle containing both
