...
> The current version is `0.10.1`. Discovery, authorization, folder browsing,
...
- `fn-sync-0.10.1-1-any.pkg.tar.zst`: Arch/pacman system package.
- `fn-sync-omarchy-plugin-0.10.1.tar.gz`: self-contained Omarchy plugin.
- `fn-sync-omarchy-bundle-0.10.1.tar.gz`: portable bundle containing both
