...
> 当前版本为 `0.10.2`。真实 fnOS 上的发现、授权、文件夹浏览和大型同步已经
...
- `fn-sync-0.10.2-1-any.pkg.tar.zst`：Arch/pacman 系统包。
- `fn-sync-omarchy-plugin-0.10.2.tar.gz`：自包含 Omarchy 插件归档。
- `fn-sync-omarchy-bundle-0.10.2.tar.gz`：包含前两者和安装器的便携包。
